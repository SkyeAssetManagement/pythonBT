...
class FeatureSelectionVisualizer:
    ...
    def create_timeline_chart(self, fig_size=(14, 8)):
    ...
    def _create_timeline_grid(self, ax):
        ...
        ax.set_title('Feature Selection Timeline (Green=High Importance, Red=Low)', 
    ...
    def create_summary_stats(self):
        ...
        stats = {
            ...
            'avg_features_per_step': np.mean(features_per_step),
            'std_features_per_step': np.std(features_per_step),
            'min_features': min(features_per_step),
            'max_features': max(features_per_step),
