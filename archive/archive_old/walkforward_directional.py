...
print("DIRECTIONAL WALK-FORWARD VALIDATION & ANALYSIS")
print("=" * 80)
print("This script runs full validation for both longonly and shortonly strategies")
print("=" * 80)

# Step 1: Run the validation
print("STEP 1: Running directional walk-forward validation...")
...
plt.savefig(f'walkforward_comprehensive_{model_type}.png', dpi=chart_dpi, bbox_inches='tight')
plt.close()
print(f"[OK] Comprehensive chart saved: walkforward_comprehensive_{model_type}.png")
...
plt.tight_layout()
plt.savefig(f'walkforward_progression_{model_type}.png', dpi=chart_dpi, bbox_inches='tight')
plt.close()
print(f"[OK] Yearly progression chart saved: walkforward_progression_{model_type}.png")
...
print(f"  [OK] walkforward_comprehensive_{model_type}.png - 6-panel detailed analysis")
print(f"  [OK] walkforward_progression_{model_type}.png - 4-panel yearly progression")
