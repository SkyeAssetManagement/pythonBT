...
def check_if_changes_applied():
    ...
    if chart_widget.exists():
        ...
        if "DRAW DEBUG: Drawing" in content:
            print("[OK] My debug code IS in chart_widget.py")
        else:
            print("[X] My debug code is NOT in chart_widget.py")
        
        # Check for my rewritten method
        if "COMPLETELY REWRITTEN: Fix black blob issue" in content:
            print("[OK] My rewritten drawing method IS in chart_widget.py")
        else:
            print("[X] My rewritten drawing method is NOT in chart_widget.py")
        
        # Check for the old batch drawing
        if "painter.drawRects(up_rects)" in content:
            print("[WARNING] Old batch drawing code is still present")
        else:
            print("[OK] Old batch drawing code has been removed")
        
        return True
    else:
        print("[X] chart_widget.py file not found!")
        return False
...
def run_with_output_capture():
    ...
    try:
        ...
        if debug_found:
            print("[OK] My debug code IS being executed")
        else:
            print("[X] My debug code is NOT being executed")
