...
def main(symbol: str, strategy_name: str, config_path: str = "config.yaml", 
         ...
         intraday_performance: bool = False):
    """
    ...
    # Step 7: Launch Ultimate Step 6 Professional Dashboard
    if launch_viz:
        print(f"\n7. Launching Ultimate Step 6 Professional Dashboard...")
        
        if ULTIMATE_DASHBOARD_AVAILABLE:
            try:
                ...
                # Convert data to format expected by Ultimate Dashboard
                ohlcv_data = {
