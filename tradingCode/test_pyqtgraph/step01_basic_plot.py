...
def test_step1():
    ...
    print("[OK] White background")
    print("[OK] Black axis lines on all sides (left, right, bottom, top)")
    print("[OK] Axis labels: 'Price ($)' on Y-axes, 'Time (bars)' on X-axis")
    print("[OK] 'Trading Chart' title at top")
    print("[OK] Numerical tick marks and values on axes")
    print("[OK] X-axis range: 0-100, Y-axis range: 0-200")
