...
def apply_candlestick_fix():
    ...
    if old_width_calc in content:
        ...
        print("[OK] Fixed parallel width calculation")
    else:
        print("[WARNING] Parallel width calculation not found - may already be updated")
    ...
    if old_simple_calc in content:
        ...
        print("[OK] Fixed simple width calculation")
    else:
        print("[WARNING] Simple width calculation not found - may already be updated")
    ...
    if old_width_logic in content:
        ...
        print("[OK] Fixed width logic in _generate_picture")
    else:
        print("[WARNING] Width logic not found - may already be updated")
    ...
    print(f"[OK] Updated main chart file: {main_chart_file}")
    print("\\n" + "="*70)
